# Component source registry — drum-internals feasibility
...
- **Sources:** product brief `assets/docs/rpi-camera-module-3-sensor-assembly-product-brief.pdf` (physical spec p.4, variants p.5) · standard datasheet `assets/docs/rpi-camera-module-3-sensor-assembly-standard-datasheet.pdf` (TNBA1392 REV 0, TSP / Chongqing TS-Precision, single-page drawing)
...
- **Sources:** `assets/docs/omnivision-ov9281-product-brief.pdf`
...
- **Sources:** `assets/docs/ams-belice-850-datasheet.pdf` (DS000618 v2-00, 2019-May-15, 23 pp)
...
- **Sources:** `assets/docs/ams-belago1-2-datasheet.pdf` (DS001002 v1-00, 2025-Apr-22, 19 pp)
- **CAD:** none published; envelope from the datasheet drawings
...
- **STEP verification (this study):** official STEP `assets/step/infineon-pg-lfbga-65-1-3d.stp` probed — union bounds **9.000 × 9.000 × 1.465 mm** = outline max tolerance exactly; 168 solids (body 9×9×0.915 cap + substrate + balls)
...
- **Sources:** `assets/docs/infineon-irs2877as-product-brief.pdf` · `assets/docs/infineon-pg-lfbga-65-1-package-outline.pdf` · `assets/step/infineon-pg-lfbga-65-1-3d.stp`
...
- **Sources:** family reference `assets/docs/infineon-irs2877as-product-brief.pdf`
