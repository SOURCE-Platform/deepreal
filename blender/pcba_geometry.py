...
def _materials():
    return {
        "package": material("PCBA_Package_Mold", (0.025, 0.028, 0.032),
                            roughness=0.28),
        "compute": material("PCBA_Compute_Package", (0.10, 0.12, 0.15),
                            metallic=0.12, roughness=0.27),
        "power": material("PCBA_Power_Package", (0.18, 0.08, 0.22),
                          roughness=0.34),
        "connector": material("PCBA_Connector_Housing", (0.56, 0.59, 0.62),
                              metallic=0.54, roughness=0.31),
        "latch": material("PCBA_FPC_Latch", (0.72, 0.74, 0.71),
                          roughness=0.36),
        "copper": material("PCBA_Pads_Copper", (0.72, 0.48, 0.10),
                           metallic=0.93, roughness=0.24),
        "ceramic": material("PCBA_Ceramic", (0.55, 0.48, 0.35),
                            roughness=0.54),
        "resistor": material("PCBA_Resistor", (0.08, 0.075, 0.07),
                             roughness=0.42),
        "inductor": material("PCBA_Power_Inductor", (0.17, 0.18, 0.19),
                             metallic=0.22, roughness=0.48),
        "bulk": material("PCBA_Bulk_Capacitor", (0.12, 0.12, 0.13),
...
def _representative_support(mats, collection):
    ...
    inductors = (("L1",28.0,-11.0,3.2,3.2), ("L2",18.0,-18.0,3.2,3.2),
                 ("L3",20.0,-2.5,3.0,3.0), ("L4",20.0,-8.0,3.0,3.0),
