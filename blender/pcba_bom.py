...
MAJOR_PARTS = (
    ...
    _part("LPDDR4X_4GB", "U4", "Micron", "MT53E1G32D2FW-046 AAT:B",
          ...
          8.5, -8.0, "TOP", "DDR_VALIDATION_REQUIRED", "Working memory",
    ...
    _part("PF53_SOC", "U6", "NXP", "MPF5302BVNAAEP",
          ...
          16.2, -2.5, "TOP", "SEQUENCE_REVIEW", "VDD_SOC regulator",
          "NXP PF53 ordering table"),
    _part("PF53_ARM", "U7", "NXP", "MPF5301BVNABEP",
          "H-FC-PQFN24", 3.5, 4.5, 0.75,
          16.2, -8.3, "TOP", "SEQUENCE_REVIEW", "VDD_ARM regulator",
          "NXP PF53 ordering table"),
...
PLANNING_ZONES = (
    ...
    ("DDR_Neighborhood", 8.5, -8.0, 12.0, 17.0, "TOP"),
